...
const Billboard = () => {
    ...
    const { openModal, closeModal } = useInfoModal();
    ...
    return (
        <div className='w-full h-[65vh] relative'>
            ...
            <div className="absolute top-[30%] md:top[40%] ml-4 md:ml-16 space-y-3 text-white">
                ...
                <div className="flex items-center mgt-3 md:mt-4 gap-3">
                    ...
                    <button
                        ...
                        className='bg-white/30 text-white rounded-md py-2 px-2 md:px-4 w-auto text-xs lg:text-lg font-semibold flex justify-center items-center hover:bg-white/20 transition'>
